levels_list = [
    ...
    },
    {
        ...
        "relationships": [
            ...
            {"name": "Green Shell Koopa Paratroopa", "description": "Level 2-1 has a few green shell koopa paratroopas", "count": 3},
            {"name": "Piranha Plant", "description": "Level 2-1 has a few piranha plants", "count": 7}, 
            ...
            {"name": "1-Up Mushroom", "description": "Level 2-1 has 1 1-up mushroom hidden in a brick block", "count": 1}, 
            {"name": "Super Mushroom", "description": "There are 4 blocks that can contain Super Mushroom power-ups in Level 2-1", "count": 4}, 
            {"name": "Fire Flower", "description": "There are 4 blocks that can contain Super Mushroom power-ups in Level 2-1", "count": 4}, 
            {"name": "Starman", "description": "There is 1 Starman powerup in Level 2-1", "count": 1}, 
            {"name": "Warp Pipe", "description": "Level 2-1 has a warp pipe that leads to a bonus room", "count": 2},
            {"name": "? Block", "description": "There are several ? blocks in Level 2-1, containing coins and power-ups", "count": 19},
    ...
    },
    {
        ...
        "name": "4-1",
        "relationships": [
            {"name": "Lakitu", "description": "Level 4-1 has a respawning Lakitu that follows Mario", "count": 1}, 
            {"name": "Spiny", "description": "Level 4-1 has a Lakitu that throws an unlimited supply of Spiny enemies"}, 
            {"name": "Piranha Plant", "description": "Level 4-1 has a few Piranha Plant enemies", "count": 4}, 
    ...
    },
    {
        ...
        "relationships": [
            ...
            {"name": "Green Shell Koopa Paratroopa", "description": "Level 5-1 has a few Green Shell Koopa Paratroopas", "count": 4},
...
mechanics = [
    {
        ...
        "notes": ["Essential for navigating levels.", "Used frequently throughout the game."],
    },
    {
        "name": "Run",
        "description": "Mario moves at a faster speed when the player holds down the run button while moving.",
        "image_url": "https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/dee38e10-db68-462d-9df7-46b87d4c7876/ddxh2tf-fc8fc42e-8794-4501-8621-31a4e68a25b5.gif?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..k7me-PhiUBQjnEu0a2FMUBFCjo5wljCAeBiTCry6ykg",
        "notes": ["Increases speed, useful for timed levels.", "Helps in avoiding enemies quickly."],
        "relationships": [{"name": "Throw Fireball", "description": "Running and throwing fireballs share the same input-the B button"}]
    },
    {
        "name": "Jump",
        ...
        "notes": ["Core mechanic for platforming.", "Allows reaching higher platforms and avoiding obstacles."],
    },
    {
        "name": "Throw Fireball",
        ...
        "notes": ["Effective for hitting enemies from a distance.", "Encourages players to jump and aim strategically."],
    ...
    },
    {
        ...
        "notes": ["Allows access to higher areas.", "Useful for exploring different level paths."],
    }
]
